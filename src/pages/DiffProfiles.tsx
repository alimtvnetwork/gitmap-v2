  ...
  <DocsLayout>
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-3xl font-mono font-bold text-foreground">Diff Profiles</h1>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Features</h2>
      ...
      {/* Resolution Logic */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Profile Resolution Logic</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Comparison Categories</h2>
      ...
      {/* Usage */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Usage</h2>
      ...
      {/* JSON Output */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">JSON Output</h2>
        <p className="text-sm text-muted-foreground mb-3">
      ...
      {/* Examples */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Examples</h2>
      ...
      {/* File Layout */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">File Layout</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm font-mono">
            <thead>
              <tr className="border-b border-border text-muted-foreground">
