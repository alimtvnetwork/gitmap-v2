  ...
  <DocsLayout>
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-3xl font-mono font-bold text-foreground">Profile</h1>
      ...
      {/* Switch Behavior */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Switch Behavior</h2>
      ...
      {/* Subcommands */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Subcommands</h2>
      ...
      {/* Database Mapping */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Database Mapping</h2>
      ...
      {/* Constraints */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Constraints</h2>
