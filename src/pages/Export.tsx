  ...
  <DocsLayout>
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-3xl font-mono font-bold text-foreground">Export</h1>
      ...
      {/* Export Schema */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Export Schema (DatabaseExport)</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm font-mono">
            <thead>
              <tr className="border-b border-border text-muted-foreground">
      ...
      {/* JSON Sample */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Sample Output</h2>
