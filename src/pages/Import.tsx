  ...
  <DocsLayout>
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-3xl font-mono font-bold text-foreground">Import</h1>
      ...
      {/* Import Strategies */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Import Behavior</h2>
      ...
      {/* Group Resolution */}
      <section className="mb-10">
        <h2 className="text-xl font-mono font-bold text-foreground mb-4">Group Slug Resolution</h2>
