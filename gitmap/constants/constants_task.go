...
const (
	...
	ErrTaskSrcNotExist   = "Source directory does not exist: %s\n"
	ErrTaskDestCreate    = "Failed to create destination directory: %v\n"
	ErrTaskLoadFile      = "Failed to load tasks file: %v\n"
	ErrTaskSaveFile      = "Failed to save tasks file: %v\n"
