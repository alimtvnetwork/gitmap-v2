...
const (
  ...
  How to fix:
    ...
    Option 1 — Re-install via the one-liner (recommended):
      irm https://raw.githubusercontent.com/AliMTVNetworkSolutions/gitmap-v2/main/gitmap/scripts/install.ps1 | iex

    Option 2 — Clone the repo and build from source:
      git clone https://github.com/AliMTVNetworkSolutions/gitmap-v2.git C:\gitmap-src
      cd C:\gitmap-src
      .\run.ps1

    Option 3 — Download the latest release manually:
      https://github.com/AliMTVNetworkSolutions/gitmap-v2/releases/latest
