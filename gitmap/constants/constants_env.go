...
const (
	...
	ErrEnvPathNotExist   = "Directory does not exist: %s\n"
	ErrEnvInvalidName    = "Invalid variable name: %s (must be alphanumeric and underscore only)\n"
	ErrEnvProfileWrite   = "Failed to write shell profile: %v\n"
	ErrEnvRegistryLoad   = "Failed to load env registry: %v\n"
	ErrEnvRegistrySave   = "Failed to save env registry: %v\n"
